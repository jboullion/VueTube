			...
			<div class="row">
				<div class="col">
					<div class="form-group">
						...
						<div class="form-check" v-for="style in getStyles" :key="style.style_id" >
							<input class="form-check-input" :id="'style'+style.style_id" type="checkbox" :value="style.style_id" v-model="channel.styles">
				...
				<div class="col">
					<div class="form-group">
						...
						<div class="form-check" v-for="topic in getTopics" :key="topic.topic_id" >
							<input class="form-check-input" :id="'topic'+topic.topic_id" type="checkbox" :value="topic.topic_id" v-model="channel.topics">
